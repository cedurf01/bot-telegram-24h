    ...
    try:
        ...
        for match in matches:
            ...
            if diff <= 1:
                ...
                msg = (
                    f"🔥 OPORTUNIDADE DE SINAL (24H) 🔥\n\n"
                    f"🏆 Competição: {competition}\n"
                    f"⚽ Confronto: {home_team} {gols_casa} x {gols_fora} {away_team}\n"
                    f"📊 Cenário: Jogo parelho em andamento!\n\n"
                    f"💡 Gols esperados / Pressão no final da partida."
                )
